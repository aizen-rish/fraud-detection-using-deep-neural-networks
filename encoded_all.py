...
#Train without classes, on all Xact.
...
with open("saved_models/model_with_frauds.json", "w") as json_file:
...
autoencoder.save_weights("saved_models/mweights_with_frauds.h5")
